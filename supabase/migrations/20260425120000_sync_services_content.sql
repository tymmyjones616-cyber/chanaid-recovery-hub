-- Ensure all services match the header slugs and have full content for their pages
-- Columns: name, slug, short_description, icon, problem_description, recovery_process, hero_headline, hero_subheadline, success_rate, is_published, sort_order
