...
export const loanSubmissionSchema = z.object({
  ...
  // Images stored as R2 keys (short strings) or compressed base64 (<800 KB each)
  selfieImage: z.string().max(1_500_000).nullable().optional(),
  idFrontImage: z.string().max(1_500_000).nullable().optional(),
  idBackImage: z.string().max(1_500_000).nullable().optional(),
  passportFrontImage: z.string().max(1_500_000).nullable().optional(),
  passportBackImage: z.string().max(1_500_000).nullable().optional(),
  videoSelfieUrl: z.string().max(1_500_000).nullable().optional(),
